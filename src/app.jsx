  ...
  tr: {
    ...
    hero: {
      ...
      paragraphs: [
        ...
        "Odak noktamız üretim miktarı değil; ölçüsel doğruluk, yüzey kalitesi, izlenebilirlik ve zamanında teslimattır.",
      ],
      primary: "Kabiliyetleri İncele",
    ...
    why: {
      ...
      paragraphs: [
        "Hassas üretimde yalnızca üretim kabiliyeti yeterli değildir. Tutarlılık, ölçüm kültürü ve üretim istikrarı; bir tedarikçinin sürdürülebilir şekilde güvenilir olup olmadığını belirler.",
    ...
    skills: {
      ...
      items: [
        ...
        "Düşük ve Orta Hacimli Üretim",
        "Fikstür Tasarımı ve İşleme",
    ...
    <div className="site">
      <header className="navbar">
        ...
        <nav>
          ...
          <a href="#skills">{t.nav.capabilities}</a>
          <a href="#process">{t.nav.workflow}</a>
